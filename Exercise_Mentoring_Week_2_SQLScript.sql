...
order by
	total_invoice desc;
-- Jawaban: Mountain View adalah Kota di USA yang memiliki Total Invoice terbanyak 14 Invoice
...
-- Jawaban : Genre Rock adalah Genre yang diminati setiap Customer yang bertransaksi
